...
tell application id "com.figure53.QLab.5" to tell front workspace
  repeat with rowIndex from 2 to theRowCount
    ...
    set q number of theCue to theCueNumber
    set q name of theCue to "Subtitle " & theCueNumber
    set text of theCue to theSubtitleText
    set text alignment of theCue to "center"
    set fixed width of theCue to 1600
    set notes of theCue to theOperatorNote

    -- Optional: only use this if your QLab workspace has a stage with this name.
    -- set stage name of theCue to "Surtitles"
  end repeat
end tell
```
