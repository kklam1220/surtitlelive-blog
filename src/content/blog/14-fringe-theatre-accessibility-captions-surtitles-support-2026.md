...
- Projection and mobile viewing at the same performance
...
Although the terms are often used interchangeably, captions and surtitles solve different problems.
...
Upload your prepared script, review its structure, divide the text into editable cue blocks, and rehearse the sequence before entering the venue.

AI-assisted tools can help create an editable first pass, but all translations, speaker labels, sound descriptions, and cue boundaries should be reviewed by the production team before performance.

### Live operator cueing

A crew member can advance prepared text in the SurtitleLive operator interface using straightforward controls.

Because the text is cued live, the operator can stay with the pace of the actors instead of relying on fixed video-style subtitle timing.

### Projected captions and surtitles

Use a venue projector, display, or suitable secondary screen when the physical setup and sightlines allow it.

Projection can provide a shared reading surface for the audience without requiring each person to use a phone. The exact projector, display, placement, text size, and contrast should be tested in the venue before opening.

### Mobile theatre captions through a QR code
...
### Projection and mobile viewing together
...
## How mobile captions work in a Fringe venue

Mobile viewing can be useful in venues where a permanent surtitle screen is impractical, setup time is limited, or sightlines make a single projected display difficult.

The basic audience journey is:

1. The production displays a QR code at the box office, in the digital programme, near the entrance, or on an access information card.
2. The audience member scans the code using their phone camera.
3. The viewer opens in a standard mobile browser.
4. The audience member selects an available language and adjusts the display where supported.
...
Audience-phone delivery requires working connectivity between the performance system and viewer devices.
...
The programme is best suited to productions that:

- Have a stable or mostly stable script
- Can prepare text before the performance
- Have a crew member available to review and cue the text
- Need projection, audience-phone delivery, or both
- Want a portable workflow that can travel between venues
- Can test the audience and operator setup before opening

## Where a different service may be required
...
- Changes significantly at every performance
...
## Eligibility for the 2026 Fringe Support Programme

To be considered, your production should meet the following criteria.

### Performance period

Your show must have performances during July, August, or September 2026.

### Prepared text

The production must be scripted or mostly scripted so that captions or surtitles can be prepared and reviewed before performance.

### Festival or showcase participation

The production must form part of an official Fringe festival, summer festival, or recognised independent showcase programme.

### Technical preparation

Your team must identify someone who can prepare, rehearse, and operate the text workflow.

### Promotional materials

Your company agrees to provide:

- Its logo
- One or two high-resolution production or promotional images
- Confirmation that it has permission to provide those materials for agreed programme marketing
...
- Include the SurtitleLive logo and a short credit such as “Accessibility support provided by SurtitleLive” in a digital programme, website, or appropriate show listing
- Mention or tag SurtitleLive when announcing the relevant accessible performances on social media
...
### 1. Create a free SurtitleLive account

[Create your free SurtitleLive account](https://surtitlelive.com/auth/register) before submitting the application so the programme team can identify the correct workspace if your production is selected.
...
- Production and company name
- Festival or showcase name
- Performance dates
- Technical rehearsal dates
- Link to the official ticket or festival listing
- Original performance language
- Required caption or surtitle language
- Whether you need accessibility captions, translation surtitles, or both
- Whether you expect to use projection, audience phones, or both
- Approximate venue or audience capacity
- How stable the script is
...
### Do audiences need to download an app?

No. Mobile viewers open in a standard web browser. Audience members do not need to install a dedicated SurtitleLive viewer app.

### Can we use projection and audience phones at the same time?

Yes. A production can deliver prepared text to a suitable venue display and audience phones during the same performance.

The final setup should be tested in the actual venue, including sightlines, connectivity, and front-of-house instructions.

### Can we use languages other than English?
...
No. The programme provides selected productions with a free 14-day period of SurtitleLive Pro software access.

It does not provide a cash grant, production crew, translation service, live captioner, or managed accessibility operation.

### What if our performance run is longer than 14 days?
...
SurtitleLive is primarily designed for prepared text.

A substantially improvised performance, live discussion, or production with extensive unscripted audience interaction may require a live captioner, speech-to-text service, or hybrid setup.

### Will mobile captions work without internet access?

No. Audience-phone delivery depends on connectivity.

A separately prepared QLab projection workflow can continue to control local projection if mobile sync is interrupted, but it must be configured and rehearsed in advance. This does not make audience-phone viewing offline.
