---
title: 'Fringe Accessibility Captions & Multilingual Surtitles Support 2026'
description: 'Apply for a free 14-day SurtitleLive Pro trial for Fringe shows needing multilingual surtitles, accessibility captions, QR-code mobile viewing, projection, and up to 150 viewers.'
pubDate: '2026-06-15'
heroImage: './blog-12.png'
heroImageAlt: 'SurtitleLive Fringe accessibility captions and multilingual surtitles support programme for international theatre companies'
tags: ['Fringe accessibility', 'Multilingual surtitles', 'Theatre captions', 'Non-English theatre', 'Mobile theatre captions']
---
...
For a deeper decision guide, read [captions vs surtitles for Edinburgh Fringe shows](/blog/11-captions-vs-surtitles-edinburgh-fringe/).
...
For product-fit details, see [mobile theatre subtitles for audience phones](/mobile-theatre-subtitles) and [QR code theatre subtitles](/qr-code-theatre-subtitles).
...
For non-English productions, you may also find this useful: [how to add English surtitles to a non-English Fringe show](/blog/9-english-surtitles-non-english-show-fringe/).
...
1. **Active 2026 festival or showcase run**
   Your production must be scheduled to perform at a Fringe festival, independent showcase, or touring performance context in June, July, August, or September 2026.

2. **A real captioning or surtitling use case**
   Your show should need translated surtitles, accessibility captions, mobile theatre captions, projected surtitles, multilingual audience access, or a combination of those workflows.

3. **A prepared or mostly stable performance text**
   SurtitleLive works best when the production has a script, libretto, or mostly stable performance text that can be reviewed before opening.

4. **Promotional assets**
   Applicants should be able to provide a show logo and 1–2 production or promotional images.

5. **Credit and feedback**
   Selected teams should be willing to add a small SurtitleLive credit line and complete a short post-show feedback survey.
