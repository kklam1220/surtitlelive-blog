...
export const BLOG_LOCALE_META: Record<BlogSupportedLocale, BlogLocaleMeta> = {
	...
	pt: {
		...
		blogDescription: 'Guias para equipes de teatro, ópera e festivais sobre legendas, sobretítulos, revisão, projeção, celulares do público e operação durante o espetáculo.',
